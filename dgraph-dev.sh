...
#   echo $csum /usr/local/bin/dgraph >> ../dgraph-checksum-linux-arm64.sha256
#   csum=$(shasum -a 256 dgraph-ratel | awk '{print $1}')
#   echo $csum /usr/local/bin/dgraph-ratel >> ../dgraph-checksum-linux-arm64.sha256
# popd
...
# echo "Creating tar"
# pushd $TMP/linux
#   tar -zcvf ../dgraph-linux-arm64.tar.gz *
# popd
rm -Rf $TMP/linux
